# -*- coding: utf-8 -*-
"""
Django settings for Wifinder project.
...
ROOT_DIR = environ.Path(__file__) - 3  # (wifinder/config/settings/common.py - 3 = wifinder/)
APPS_DIR = ROOT_DIR.path('wifinder')
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'wifinder.contrib.sites.migrations'
}
...
ADMINS = (
    ("""Saber Safavi""", 'sabersafavi@gmail.com'),
)
...
ACCOUNT_ADAPTER = 'wifinder.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'wifinder.users.adapters.SocialAccountAdapter'
